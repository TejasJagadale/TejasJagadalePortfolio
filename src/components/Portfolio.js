...
export default function Portfolio() {
  ...
  const projects = useMemo(
    () => [
      ...
      },
      {
        ...
        category: "Web",
        desc: "Maintained admin panel to manage system configurations, user roles, and administrative tasks.",
        year: 2024,
        link: "#",
      },
      {
        ...
        tags: ["AI", "Node.js"],
        category: "AI",
        desc: "Developed Data Extraction system using Node.js, Vision AI and Gen AI.",
        year: 2024,
        link: "#",
      },
      {
        ...
        category: "Infra",
        desc: "Optimized AWS resources and implemented cost-saving measures, reducing costs by over 200%.",
        year: 2024,
        link: "#",
      },
      {
        ...
        tags: ["React", "Next.js"],
        category: "Web",
        desc: "Developed responsive and user-friendly websites using React.js, Next.js, and CSS frameworks.",
        year: 2025,
        link: "#",
      },
    ],
  ...
  const categories = ["All", "AI", "Web", "Infra"];
              ...
              <div className="col">
                <div className="btn-group">
                  {categories.map((c) => (
                    <button
                      key={c}
                      className={`btn btn-sm ${category === c ? "active" : ""}`}
        ...
        <div className="row g-4 educ">
          ...
          <div className="col col-6 col-md-12">
            <div className="card luxe">
              ...
              <ul className="checklist">
                <li>Full Stack Web Development - Edureka</li>
                <li>
